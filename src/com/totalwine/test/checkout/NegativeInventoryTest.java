...
public class NegativeInventoryTest extends Browser {
	...
	@Test (dataProvider = "CheckoutParameters",invocationCount=1)
	public void ISPCheckoutTest (String Location,String StoreName,String PDP,String ISPOption,String Quantity,String Email,String CreditCard,String ExpirationMonth,String ExpirationYear,
		...
		String[] ProductURL = {"/wine/red-wine/red-blend/bevan-proprietary-red-sugarloaf-mountain-oscar/p/129666750","/wine/red-wine/merlot/duckhorn-merlot-napa/p/3809750","/spirits/tequila/blanco-silver/sauza-hornitos-plata-tequila/p/103361750","/wine/red-wine/rhone-blend/domaine-fontanyl-cotes-de-provence/p/100452750"};
